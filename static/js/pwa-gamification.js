...
(function () {
  ...
  /* ── Staff-page guard ─────────────────────────────────────── */
  /* No XP events on manager/admin/partner back-office pages.   */
  var staffPagePattern = /^\/(manager|admin|partner)(\/|$)/;
  var isStaffPage = staffPagePattern.test(window.location.pathname);
  /* Hide mascot on mobile for property/complex search pages — it overlaps search UI */
  var searchPagePattern = /\/(properties|novostrojki|complexes|zhilye-kompleksy)(\/|\?|$)/;
  ...
  var QUESTS = [
    { id:'q_search',   icon:'🔍', text:'Найдите квартиру по фильтрам',   cta:'Открыть поиск',   url:'/krasnodar/properties/',   xp:30 },
    { id:'q_complex',  icon:'🏙️', text:'Посмотрите жилые комплексы',      cta:'Смотреть ЖК',     url:'/krasnodar/complexes/',    xp:25 },
    { id:'q_cashback', icon:'💰', text:'Узнайте размер своего кэшбека',   cta:'Рассчитать',      url:'/kak-eto-rabotaet',        xp:20 },
    { id:'q_map',      icon:'🗺️', text:'Найдите квартиру на карте',       cta:'Открыть карту',   url:'/krasnodar/properties/?view=map', xp:35 },
    { id:'q_consult',  icon:'💬', text:'Напишите менеджеру — бесплатно', cta:'Написать нам',    action:'chat',                  xp:40 },
    { id:'q_fav',      icon:'❤️', text:'Добавьте объект в избранное',     cta:'К недвижимости',  url:'/krasnodar/properties/',   xp:25 },
  ];
